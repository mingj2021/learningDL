...
class PadimModel(nn.Module):
    def __init__(self,
        ...
        self.layers = layers
        self.feature_extractor = FeatureExtractorVgg16()
...
def train():
    input_size=(256, 256)
    model = PadimModel(input_size=input_size, backbone='resnet18', layers=['0','1','2'])# layers=['layer1','layer2','layer3']
    # summary(model.to('cuda:0'),(3,256,256),depth=3)
    ROOT = Path(
        'C:/Users/77274/workspace/projects/anomalib/datasets/MVTec/bottle/train/good')
    ...
    im = Image.open(
        'C:/Users/77274/workspace/projects/anomalib/datasets/MVTec/bottle/test/good/000.png')
    im = im.convert('RGB')
...
def predict():
    ...
    input_size = (256, 256)
    model = PadimModel(input_size=input_size, backbone='resnet18', layers=['0','1','2'])#
    # model = PadimModel(input_size=input_size, backbone='resnet18', layers=['features_1'])# layers=['layer1','layer2','layer3']
    transforms = torchvision.transforms.Compose(
        [torchvision.transforms.Resize(input_size), torchvision.transforms.ToTensor()])
    ROOT = 'C:/Users/77274/workspace/projects/anomalib/datasets/MVTec/bottle/test/good/'
